...
* > Запустить среду разработки и открыть проект
* > Сконфигурировать запуск приложения, указать аргументы и указать основной класс
* > Запустить приложение
* В том случае, если среда разработки указывает на якобы потерянные классы, необходимо почистить кэш приложения